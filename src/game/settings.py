...
class Settings:
    ...
    def __init__(self, screen: pygame.surface.Surface) -> None:
        ...
        self.__checkmark1 = load("textures/checkmark1.png", (50, 50), "convert")
        self.__checkmark2 = load("textures/checkmark2.png", (50, 50), "convert")
    ...
    def main_functional(self) -> None:
        ...
        try:
            if (
                rect1.collidepoint(pygame.mouse.get_pos())
