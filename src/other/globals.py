...
some_dict = {  # Эти данные в каждом файле в папке data
    ...
    "items": {
        1: [150, 150, 3, 3, 'pygame.image.load("textures/stick.png")'],
        2: [320, 320, 3, 3, 'pygame.image.load("textures/stone.png")'],
        3: [220, 220, 3, 1, 'pygame.image.load("textures/poroh.png")'],
        4: [
            0,
            0,
            9,
        ...
        10: [
            ...
            9,
            5,
            "pygame.image.load('textures/shovel.png')",
            "textures/shovel.png",
        ],
        11: [
            0,
            ...
            9,
            5,
            "pygame.image.load('textures/ognivo.png')",
            "textures/ognivo.png",
        ],
        12: [
            0,
    ...
    "items_id": [],
    "MON": 100,
    "money": {1: [300, 300, 1, 2, 100], 2: [350, 250, 1, 3, 350]},
    "npc_products": {
    ...
    "vehicles": {1: [30, 30, 1, 1, "texture/boat.png"]},
    "closet_items": ["12", "13"],
}
