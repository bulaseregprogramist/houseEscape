...
class GameObjectsConfig:
        ...
        def __init__(self, x: int, y: int, texture, index: int,
                he_map: list[int, int], location: list[int, int]) -> None:
            self.x = x 
            self.y = y
...
class GameObjectsConfig2:
        ...
        def __init__(self, x: int, y: int, texture, name: str,
                he_map: list[int, int], location: list[int, int],
                i: int) -> None:
            self.x = x 
            self.y = y
            self.texture = texture
...
class GameObjectsConfig3:
        ...
        def __init__(self, x: int, y: int, some_list: list,
                he_map: list[int, int], texture, player) -> None:
            self.x = x 
            self.y = y
...
class GameObjectsConfig4:
        ...
        def __init__(self, i: int, screen, n: int, he_map: list[int, int],
                     player, logger, use) -> None:
            self.i: int = i
            self.screen = screen
            self.n: int = n
            self.he_map = he_map
...
class GameObjectsConfig5:
        ...
        def __init__(self, x: int, y: int, texture, he_map: list[int, int],
                     some_list: list, i: int, n: int, player, use) -> None:
            self.x = x
            self.y = y
            self.texture = texture
            self.he_map: list[int, int] = he_map
